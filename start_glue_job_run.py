...
def main(args):
    ...
    glue_args = make_glue_job_args(args.input_bucket_name, args.output_bucket_name, argsl.log_date_prefix, args.output_partition_count)
    client.start_jonb_run(JobName=args.glue_job_name, Arguments=glue_args)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-partition-count', type=int, default=48)
